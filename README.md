안녕하세요!  
저는 실용적이고 사용자 중심적인 애플리케이션을 만드는 데 열정을 가진 개발자입니다. 다양한 도메인에서 기술과 창의력을 결합한 여러 사이드 프로젝트를 진행하며 경험을 쌓아왔습니다. 아래는 제가 지금까지 개발한 프로젝트의 연혁입니다.  
...
## **2022년**  
- ### **타로맛집**  
  타로와 사주 명소를 공유할 수 있는 플랫폼으로, 사용자들이 유용한 정보를 발견하고 공유할 수 있도록 도와줍니다.

Android : https://play.google.com/store/apps/details?id=com.studioodoc.TaroMatjip_flutter

- ### **불경 듣기**  
  불경을 스트리밍하며 들을 수 있는 앱으로, 영적 콘텐츠를 원하는 사용자들에게 특화된 서비스를 제공합니다.

Android : https://play.google.com/store/apps/details?id=com.studioodoc.bulkyung_listening

## **2023년**  
- ### **복지 정보 공유 앱**  
  복지 혜택 및 정보를 쉽게 접근할 수 있도록 도와주는 플랫폼으로, 사용자와 필요한 정보를 연결해주는 역할을 합니다.

Android : https://play.google.com/store/apps/details?id=com.studioodoc.easy_welfare_membership

## **2024년**  
- ### **Scribbly**  
  사용자가 일상의 감정을 그림으로 표현할 수 있는 감정 그림 다이어리 앱입니다.

iOS : https://apps.apple.com/kr/app/scribbly-emotion-draw-diary/id6581487654

Android: https://play.google.com/store/apps/details?id=com.studioodoc.gamda

- ### **ID Photo Editor**  
  여권 및 신분증 사진을 편집할 수 있는 도구로, 사진 크기 조정 및 포맷팅을 간편하게 제공합니다.

iOS : https://apps.apple.com/kr/app/id-photo-editor/id6737410043

Android : https://play.google.com/store/apps/details?id=com.studioodoc.id_photo_editor

- ### **Simple Blackbox**  
  운전 중 영상을 녹화하고 관리할 수 있는 간단하고 신뢰성 높은 블랙박스 앱입니다.

iOS : https://apps.apple.com/kr/app/simple-blackbox-4k-cctv/id6686401970

Android : https://play.google.com/store/apps/details?id=com.studioodoc.blackbox_phone
